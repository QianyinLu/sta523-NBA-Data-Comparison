...
In the data_scraping.R, firstly we scraped the Game Log as well as shooting data of LeBron James (regular season, 2004-2019) and Kevin Durant from (regular season, 2008-2019) from basketball-reference.com. Then we scraped both LeBron James's (2006-2018) and Kevin Durant's (2010-2014, 2016-2019) Playoffs Game Log. At last we scraped their regular season average data from espn.com. We saved the raw data in james_raw.rds and durant_raw.rds.
